...
%                       Default is 1.
% 'List'				(integer list) list of indices of Hermite Function
%						Defaulr is 0:10 
%
...
%
% 'numRandomStarts'		Number of times to run every round with random start, 
%						trying to find best direction in remaining space
%======================================================================
...
if (rem(length(varargin),2)==1)
  ...
  for i=1:2:(length(varargin)-1)
    ...
    switch lower (varargin{i})
	 ...
	 case 'numrandomstarts'
	  numRandomStarts = varargin{i+1};
     case 'only'
...
if only > 2
  ...
  [A, W] = fpica (whitesig,  whiteningMatrix, dewhiteningMatrix, approach, ...
		  ...
		  displayMode, displayInterval, verbose, nList, numRandomStarts);
